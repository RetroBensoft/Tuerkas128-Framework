...
RAM0_LENGTH			EQU		16315							; Size of bank0.bin file 	(FSMs for game etities) [CUSTOM]
RAM2_LENGTH			EQU		16086							; Size of bank2.bin file 	(game loop and rendering routines) [FRAMEWORK CORE]
RAM5_LENGTH			EQU		9378							; Size of bank5.bin file 	(blocks and superblocks; gamevars) [CUSTOM]
RAM7_LENGTH			EQU		9152							; Size of bank7.bin file 	(free to use)
RAMFB1_LENGTH		EQU		10319						; Size of bankFB1.bin file 	(sound tracker) (music & FX) [CUSTOM]
RAMFB2_LENGTH		EQU		15746						; Size of bankFB2.bin file 	(game map) [CUSTOM]
RAMSB1_LENGTH		EQU		15185						; Size of bankSB1.bin file 	(intro, menu, game over) [CUSTOM]
RAMSB2_LENGTH		EQU		16376						; Size of bankSB2.bin file	(bitmaps for sprites an aminated blocks) [CUSTOM]
